...
%.o: ../%.cpp subdir.mk
	...
	aarch64-poky-linux-g++ -DYOLOV2 -I/opt/poky/rzv2l/sysroots/aarch64-poky-linux/usr/include/opencv4 -O0 -g3 -Wall -c -fmessage-length=0 --sysroot=/opt/poky/rzv2l/sysroots/aarch64-poky-linux -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
